...
class AdvancedSearchBuildQViewTests(SimpleTestCase):
    def test_buildqview_returns_q_json_for_valid_post(self):
        ...
        self.assertEqual(content["q"], "foo bar")

    def test_buildqview_returns_empty_json_for_invalid_post(self):
        factory = RequestFactory()
        ...
        self.assertTrue(content == {} or ("q" in content and content["q"] == ""))
