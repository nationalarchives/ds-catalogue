...
class DateComponentFieldTest(TestCase):
    ...
    def test_year_month_to_date_various_months(self):
        ...
        for year, month, expected_day in test_cases:
            ...
            self.assertEqual(field.day, expected_day, f"Wrong day for {year}-{month}")
    ...
    def test_partial_date_missing_month_with_day(self):
        ...
        self.assertFalse(field.is_valid())
        self.assertIn("Month is required if day is provided", field.error["text"])
...
class CatalogueSearchFormDateTest(TestCase):
    ...
    def test_get_api_date_params(self):
        ...
        self.assertNotIn("opening_date_to", api_params)  # Should not include None values
    ...
    def test_leap_year_february_computation(self):
        ...
        data_leap = QueryDict(
            "q=test&group=tna&"
            "rd_to-year=2012&rd_to-month=2&rd_to-day="
        )
        ...
        data_non_leap = QueryDict(
            "q=test&group=tna&"
            "rd_to-year=2013&rd_to-month=2&rd_to-day="
        )
    ...
    def test_invalid_date_in_form(self):
        ...
        self.assertIn("Invalid day for the given month", form.errors["rd_from"]["text"])
    ...
    def test_mixed_partial_and_complete_dates(self):
        ...
        self.assertEqual(form.fields[FieldsConstant.RECORD_DATE_FROM].cleaned, date(2020, 1, 1))
        self.assertEqual(form.fields[FieldsConstant.RECORD_DATE_TO].cleaned, date(2023, 6, 15))
        self.assertEqual(form.fields[FieldsConstant.OPENING_DATE_FROM].cleaned, date(2022, 3, 1))
        self.assertEqual(form.fields[FieldsConstant.OPENING_DATE_TO].cleaned, date(2024, 12, 31))