FIELD_LABELS = {
    ...
    "copies_information": {
        ...
        "description": "Indicates existence, availability, location and format of copies",
    },
    "creator": {
        "title": "Creator(s)",
    ...
    "former_department_reference": {
        ...
        "description": "Former identifier given by the originating creator",
    },
    ...
    "map_designation": {
        ...
        "description": "Identifying numbers or names given to printed maps by their publishers",
    },
    "map_scale": {
        "title": "Map scale",
        "description": "The scale of a map, plan or drawing",
    },
    "next": {"title": "Next"},
    "note": {
        "title": "Note",
    ...
    "record_opening": {
        ...
        "description": "The date an open record was made available to the public or the date a closed record is expected to become available",
    },
    "reference_number": {
        "title": "Reference",
    ...
    "related_materials": {
        ...
        "description": "A cross-reference to other related records",
    },
    "related_records": {"title": "Related records"},
    "restrictions_on_use": {
        "title": "Restrictions on use",
        "description": "Information on restrictions to the use or reproduction of the material",
    },
    "separated_materials": {
